...
**Backend & Automation**
- FastAPI — building backend services and APIs
- PostgreSQL / Neon — schema design, seed data, query optimization
- Flask — lightweight web app backends
- 
**Data Visualization & Reporting**
- Tableau, Power BI, Streamlit
- Dashboard creation for stakeholder-ready insight communication
...
- Time-series causal analysis (Granger causality, walk-forward validation)
...
### 🌾 Kenya Regional Crop Yield Prediction
*Python, Scikit-learn*

A machine learning model predicting agricultural yield across Kenyan regions, applying data science to a real local infrastructure/agriculture context.

### 📈 SyriaTel Retention & Revenue Insights
*Python, Scikit-learn*

Consolidated and validated telecom customer datasets, analyzed churn patterns, and identified high-risk segments to inform retention strategy.

## Contact

- LinkedIn: [linkedin.com/in/sheilla-macharia-458422324](https://www.linkedin.com/in/sheilla-macharia-458422324)
- Email: [sheilamacharia8@gmail.com](mailto:sheilamacharia8@gmail.com)
- Portfolio: [sheilamumbi.github.io/sheillamacharia.github.io](https://sheilamumbi.github.io/sheillamacharia.github.io/)
